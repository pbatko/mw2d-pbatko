...
from rule.approval.ilp import pluck
...
class PhragmenIlpRules_Test(unittest.TestCase):
    ...
    def test_phragmen_on_generated_small_elections(self):
        ...
        for data in ApprovalElectionTestDataSource().getSampleElections():
            (V, number_of_candidates, k, sample_name) = pluck(
                data,
                'V',
            ...
            expected_committee, expected_load_vector = pluck(
                expectedResult,
                'committee',
                'loads')
    ...
    def __run_single_election_var(self,
        ...
        from rules.approval.ilp.phragmen import PhragmenVar_ILP
    ...
    def __run_single_election_max(self,
        ...
        from rules.approval.ilp.phragmen import PhragmenMax_ILP
