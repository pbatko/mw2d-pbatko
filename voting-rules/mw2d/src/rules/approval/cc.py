...
# OK
from rules.approval._annealing import Annealing_Meta
from rules._base import ApprovalBasedRuleBase, ApprovalBasedRules
...
def register():
    ApprovalBasedRules.add(CC_Banzhaf)
    ApprovalBasedRules.add(CC_ReverseGreedy_Slow)
    ApprovalBasedRules.add(CC_ReverseGreedy)
    ApprovalBasedRules.add(CC_Greedy)
    ApprovalBasedRules.add(CC_Annealing)
...
class CC_Banzhaf(ApprovalBasedRuleBase):
    ...
    def apply(clazz, V, number_of_candidates, k):
        ...
        remaining_candidates = range(number_of_candidates)
...
class CC_ReverseGreedy_Slow(ApprovalBasedRuleBase):
    ...
    def apply(clazz, V, number_of_candidates, k, ):
        ...
        committee = range(number_of_candidates)
...
class CC_Greedy(ApprovalBasedRuleBase):
    ...
    def apply(clazz, V, number_of_candidates, k):
        ...
        def computeVotersApprovingACandidates():
