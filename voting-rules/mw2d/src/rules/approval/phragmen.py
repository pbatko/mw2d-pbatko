...
def register():
    ApprovalBasedRules.add(PhragmenMax_Seq)
    ApprovalBasedRules.add(PhragmenVar_Seq)
...
# TODO
def _seqPhragmen(V, k, number_of_candidates, isMax=False, isVar=False):
    # type: (list[list[int]], int) -> list[int]
    ...
    def computeBackersForEachCandidate():
        # type: () -> list[set[int]]
